...
title <- "Training"
assessment1 <-
  createAssessment("Assessment1", "data/ass1.csv", sep = ",",quote = "\"", sbs = T)
assessment2 <-
  createAssessment(
...
assessment3 <-
  createAssessment("Placeholder", "data/ass1.csv", sep = ",",quote = "\"")
assessment4 <-
  createAssessment("Insert_Title_Here", "data/ass2.csv", sep = ",",quote = "\"",
                   norm.meanlog = 2, norm.sdlog = 2, choice.inline = F, sbs = T
  )
assessment5 <-
  createAssessment("ok", "data/ass1.csv", sep = ",",quote = "\"")
